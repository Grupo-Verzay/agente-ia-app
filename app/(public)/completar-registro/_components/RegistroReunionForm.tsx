    ...
    return (
      <div className="flex flex-col items-center gap-4 pt-4 pb-0 text-center">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-1 text-sm">Tu agente IA fue configurado y está listo para activarse.</p>
        </div>
        ...
        <p className="text-xs text-slate-500">7 días de prueba gratis · Sin tarjeta de crédito</p>
      </div>
    );
  }
