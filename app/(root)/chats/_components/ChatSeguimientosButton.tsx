  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-7 min-w-7 items-center justify-center gap-0.5 rounded-md border border-amber-300 bg-amber-100 px-1 text-amber-800 hover:bg-amber-200 focus:outline-none transition-colors"
      >
