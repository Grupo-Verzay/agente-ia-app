 ...
 *
 * Esto eran cuatro `Card` a todo lo ancho —«Total», «Pagaron», «No pagaron»,
...
export const BillingCrmFiltrosRapidos = ({
    ...
    const metricas: Metrica[] = [
        ...
        },
        {
            ...
            valor: paidCount,
            color: "#22C55E",
            ayuda: "Cuentas con el cobro al día.",
            alPulsar: () => setExclusiveFilter("paid", "PAID"),
            activa: paidFilter === "PAID",
        },
        {
            clave: "unpaid",
            icono: <CircleX />,
            ...
            valor: unpaidCount,
            color: "#EF4444",
            ayuda: "Cuentas con el cobro pendiente.",
