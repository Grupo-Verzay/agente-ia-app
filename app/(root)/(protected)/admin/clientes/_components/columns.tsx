...
export const getColumns = (openDialogGetUserId: (userId: string, dialog: DialogType, state: boolean) => void, currentUserRol: string): ColumnDef<ClientInterface>[] => [
  ...
  },
  {
    ...
    // Las cuentas de prueba se listan junto a las demas, con su etiqueta. Antes
    // quedaban fuera de esta lista y la unica pantalla que las mostraba se dio
    // de baja: se creaban y no aparecian por ningun sitio.
    cell: ({ row }) => (
