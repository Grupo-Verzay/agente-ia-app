...
export const MainAi = ({ flows, user, promptMeta, sections }: MainAiProps) => {
    ...
    const ALL_TEMPLATE_CHIPS = ["Restaurante","Clínica","E-commerce","Inmobiliaria","Academia","Belleza","Viajes","Venta Consultiva","Venta Directa","Agendamiento","Leads","Soporte"];
