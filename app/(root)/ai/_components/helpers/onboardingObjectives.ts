...
✅ SECUENCIA OBLIGATORIA (orden estricto):
1º Si existe el flujo 'PRESENTACION', ejecutarlo; si NO existe, continuar igual.
...
✅ SECUENCIA OBLIGATORIA (orden estricto):
1º Si existe el flujo 'DISPONIBILIDAD', ejecutarlo; si NO existe, continuar igual.
...
✅ SECUENCIA OBLIGATORIA (orden estricto):
1º Si existe el flujo 'VALIDACION', ejecutarlo; si NO existe, continuar igual.
...
✅ SECUENCIA OBLIGATORIA (orden estricto):
1º Si existe el flujo 'RESOLUCION', ejecutarlo; si NO existe, continuar igual.
