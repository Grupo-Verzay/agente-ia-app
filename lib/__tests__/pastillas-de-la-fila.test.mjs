 ...
 *
 * Dos bajaron 2 px por lado y nada más —que es de lo que va este banco—. Las
 * otras cuatro cambiaron además de FAMILIA, y por eso llevan su propio «ahora»
 * en vez de salir de restarle 2 al «antes»:
 *
 *   - ETIQUETAS, FLUJOS y SEGUIMIENTOS son CONTADORAS —icono de 12 y número de
 *     10, con 4 px de relleno—, porque eso es lo que son. Iban como pastillas
 *     de texto (12 px de letra y 6 de relleno) y se leían como otra cosa.
 *   - ASIGNAR es una pastilla de TEXTO, con la letra y el relleno de la
 *     calificación de al lado. Iba dos escalones por debajo (10 px de letra,
 *     2 de relleno) para hacerle sitio a un icono de persona que ya no lleva.
 */
const PASTILLAS = [
    { que: "estado", antes: 8, ahora: 6, letra: "12px" },
    { que: "asignar", antes: 4, ahora: 6, letra: "10px", letraAhora: "12px" },
    { que: "recordatorios", antes: 6, ahora: 4, letra: "10px" },
    { que: "flujos", antes: 8, ahora: 4, letra: "12px", letraAhora: "10px" },
    { que: "seguimientos", antes: 8, ahora: 4, letra: "12px", letraAhora: "10px" },
