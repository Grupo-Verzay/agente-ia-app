    ...
    try {
        const medir = async (conLosDosValores) => {
            ...
            return page.evaluate(() => {
                ...
                // El renglón de pastillas: por su marca donde la hay, y por
                // su clase en `origin/main`, que iba con `flex-wrap`.
                const badges =
                    fila.querySelector("[data-renglon-de-pastillas]") ?? fila.querySelector(".flex-wrap");
                return {
